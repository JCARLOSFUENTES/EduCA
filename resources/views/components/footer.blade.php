<footer class="bg-white rounded-lg shadow m-4">
    <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {{now()->year}} <a href="https://flowbite.com/" class="hover:underline">EduCA™</a>. Todos los derechos reservados.
    </span>
